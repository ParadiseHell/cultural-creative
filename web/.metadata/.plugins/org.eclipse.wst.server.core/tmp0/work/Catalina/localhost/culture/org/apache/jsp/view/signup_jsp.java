 ...
 * Generated at: 2017-01-08 13:54:44 UTC
...
return;
	...
	if(webTip != null){
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"container scholar-form col-md-6\">\r\n");
      out.write("\t\t\t\t<h3>注册</h3>\r\n");
      out.write("\t\t\t\t<hr>\r\n");
      out.write("\t\t\t\t<form role=\"form\" method=\"POST\" action=\"");
      out.print(request.getContextPath());
      out.print(ParamUtils.SERVLET_USER_SIGNUP);
      out.write("\" id=\"signup\">\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label>密码</label> <input type=\"password\" id=\"password\"\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"form-control\" placeholder=\"请输入密码\" name=\"");
      out.print(ParamUtils.ATTR_USER_PASSWORD);
      out.write("\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t<label>确定密码</label> <input type=\"password\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\tplaceholder=\"请输入密码\" name=\"ensurePassword\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"checkbox\">\r\n");
      out.write("\t\t\t\t\t    <label>\r\n");
      out.write("\t\t\t\t\t      <input type=\"checkbox\" name=\"");
      out.print(ParamUtils.ATTR_USER_TYPE);
      out.write("\"> 公司用户?\r\n");
      out.write("\t\t\t\t\t    </label>\r\n");
      out.write("\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success btn-block\">注册</button>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"signUpModal\" tabindex=\"-1\" role=\"dialog\"\r\n");
      ...
      out.write("\t\t\t\t\t<p></p>\r\n");
      out.write("\t\t\t\t\t<a data-dismiss=\"modal\" role=\"button\" class=\"btn btn-success left\">重新注册</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
