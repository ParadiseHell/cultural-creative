	...
	<div class="container-fluid container-bg">
		<div class="row row-bg">
			<div class="col-md-6 big-image">
				<img class="img-responsive" src="<%=request.getContextPath()%>/images/bg.jpg" alt="">
			</div>
			<div class="container scholar-form col-md-6">
				<h3>注册</h3>
				<hr>
				<form role="form" method="POST" action="<%=request.getContextPath()%><%=ParamUtils.SERVLET_USER_SIGNUP%>" id="signup">
					...
					<div class="form-group">
						<label>密码</label> <input type="password" id="password"
							class="form-control" placeholder="请输入密码" name="<%=ParamUtils.ATTR_USER_PASSWORD%>">
					</div>
					<div class="form-group">
					...
					<div class="checkbox">
					    <label>
					      <input type="checkbox" name="<%=ParamUtils.ATTR_USER_TYPE%>"> 公司用户?
					    </label>
					</div>					
